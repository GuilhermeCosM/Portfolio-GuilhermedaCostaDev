...
export function Projetos() {
  return (
    <section id="projetos" className="px-6 py-24 border-t border-border bg-surface-alt">
      <div className="max-w-3xl mx-auto">
        <SectionEyebrow>projetos</SectionEyebrow>
        <h2 className="font-mono text-2xl md:text-3xl font-semibold mb-10">O que eu construí</h2>
                ...
                <div className="rounded-lg overflow-hidden bg-surface border border-border transition-transform hover:-translate-y-0.5">
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between gap-3 mb-2">
                      <div className="font-mono text-[11px] uppercase tracking-wider text-cyan">{p.tag}</div>
                      {p.url && (
                        <a
                          href={p.url}
                          target="_blank"
                    ...
                    <p className="text-sm leading-relaxed mb-4 text-muted">{p.desc}</p>
